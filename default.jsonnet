...

{
  ...
  MY_VILLAGE_POINT_REQUIREMENT_LEVEL: {
    ...
    en: '§flevel §c%d §fof cultivation §c%s',
  },
  MY_VILLAGE_TUTORIAL_STAGE_FOUR_DESC: {
    _divinecraft: {
      ...
      en: [
        ' ',
        '§fFor §6navigation§f on the farm use §epointers§f!',
        '§fThey will always §fshow§f where the relevant farm is',
        '§fUse your §acompass if you want to increase',
        '§6your profit §ror §esimplify movement.',
        '§fDon’t forget you can always §cbe the TOP',
        '§fof this mode and get §bdivinity §fas a reward',
        ' ',
      ],
    },
    _fixmine: {
      ...
      en: [
        ...
        '§6your profit §ror §esimplify movement.',
        '§fDon’t forget you can always §cbe the TOP',
        '§fof this mode and get §bsilver §fas a reward',
        ' ',
      ],
    },
    _flexmine: {
      ...
      en: [
        ...
        '§6your profit §ror §esimplify movement.',
        '§fDon’t forget you can always §cbe the TOP',
        '§fof this mode and get §bkoins §fas a reward',
        ' ',
      ],
    },
    _julius: {
    ...
    _kanddy: {
      ...
      en: [
        ...
        '§6your profit §ror §esimplify movement.',
        '§fDon’t forget you can always §cbe the TOP',
        '§fof this mode and get §bgingerbread §fas a reward',
        ' ',
      ],
    },
    ru: [
    ...
    en: [
      ...
      '§6your profit §ror §esimplify movement.',
      '§fDon’t forget you can always §cbe the TOP',
      '§fof this mode and get §bemerald §fas a reward',
      ' ',
    ],
  },
  MY_VILLAGE_TUTORIAL_STAGE_ONE_DESC: {
    _divinecraft: {
      ...
      en: [
        ' ',
        '§6Welcome§f to the mode §5§lMyFarm',
        '§aMake hay§f to get §emoney§f and then',
        '§fuse it to buy §avarious farms§f that',
        '§fwill bring in steady §eprofit',
        ' ',
      ],
    },
    _fixmine: {
    ...
    en: [
      ' ',
      '§6Welcome§f to the mode §2§lMyFarm',
      '§aMake hay§f to get §emoney§f and then',
      '§fuse it to buy §avarious farms§f that',
      '§fwill bring in steady §eprofit',
      ' ',
  ...
  MY_VILLAGE_TUTORIAL_STAGE_THREE_DESC: {
    ...
    en: [
      ' ',
      '§fApart from §eWheat §fthere are §aother plants§f,',
      '§fEach one of them will unlock, not at once but',
      '§fas soon as you §eupgrade §fthe previous one §c5 times',
      '§fThe more §6expensive the plant§f — the §6more the profit§f,',
      '§fChoose the order of your purchases and upgrades carefully!',
      ' ',
    ],
  },
  MY_VILLAGE_TUTORIAL_STAGE_TWO_DESC: {
    ...
    en: [
      ' ',
      '§fYou have earned your §afirst farm§f!',
      '§6Buy §ffirst upgrade of §eWheat §fand',
      '§fget passive §6income§f, don’t forget',
      '§fto §aincrease it §ffor §6higher income',
      ' ',
    ],
  },
  NAME_IS_INVALID: {
  ...
  VILLAGE_HELP: {
    ...
    en: [
      '',
      '§7Info on how to play will be here',
      '§7123',
      '§7234',
    ],
  },
  ...
  YOU_CANT_SEE_ANOTHER_PLAYERS_STATS: {
    ...
    en: '§cError, only %s §ccan view others’ stats',
  },

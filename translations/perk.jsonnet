...

{
  ...
  BW_BOXER_LORE: {
    ...
    en: [
      ...
      '§7you get the constant effect of Strenth I',
    ],
  },
  BW_BUSINESSMAN: {
    ru: 'Бизнесмен',
  ...
  BW_MANIAC_LORE: {
    ...
    en: [
      ...
      '§7bed, you get the effect of Strenth I',
      '§7for 15 seconds',
    ],
  },
  BW_MISER: {
  ...
  EW_MANIAC_LORE: {
    ...
    en: [
      ...
      '§7you receive Strenth I for 15 seconds',
    ],
  },
  EW_RANDOM_ARMOR: {
    ru: 'Радужная броня',
  ...
  HNS_LAST_HOPE_LORE: {
    ...
    en: [
      ...
      '§7you get endless Strenth, Speed and',
  ...
  SW_INSANE_BERSERK_LORE: {
    ...
    en: [
      ...
      '§7you get Strenth II for 5 seconds',
    ],
  },
  SW_INSANE_BOMBER: {
    ru: 'Взрывной парень',

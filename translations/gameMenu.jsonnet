{
  ...
  MY_VILLAGE_LORE: {
    ru: [
        '§8Кликер в Minecraft',
        '',
        '§7Игровой режим, в котором Вы можете',
        '§7зарабатывать миллионы',
        '§7прокачивать свою доходность',
        '§7и соревноваться с другими',
        '§7игроками за звание самого',
        '§7богатого игрока сервера',
        ''
    ]
  },
  ANARCHY_LORE: {
